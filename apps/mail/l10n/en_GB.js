OC.L10N.register(
    ...
    "The account for {email} and cached email data will be removed from Omni365, but not from your email provider." : "The account for {email} and cached email data will be removed from Omni365, but not from your email provider.",
    ...
    "This setting only makes most sense if you use the same user back-end for your Omni365 and mail server of your organization." : "This setting only makes most sense if you use the same user back-end for your Omni365 and mail server of your organisation.",
    ...
    "A multi value attribute to provision email aliases. For each value an alias is created. Aliases existing in Omni365 which are not in the LDAP directory are deleted." : "A multi value attribute to provision email aliases. For each value an alias is created. Aliases existing in Omni365 which are not in the LDAP directory are deleted.",
