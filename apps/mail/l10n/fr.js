OC.L10N.register(
    ...
    "The account for {email} and cached email data will be removed from Omni365, but not from your email provider." : "Le compte pour {email} et les données de messagerie mises en cache seront supprimés de Omni365, mais pas de votre fournisseur de messagerie.",
    ...
    "This setting only makes most sense if you use the same user back-end for your Omni365 and mail server of your organization." : "Ce paramètre n'a de sens que si vous utilisez le même service d'utilisateurs pour votre Omni365 et le serveur de messagerie de votre organisation.",
    ...
    "A multi value attribute to provision email aliases. For each value an alias is created. Aliases existing in Omni365 which are not in the LDAP directory are deleted." : "Un attribut multi-valeurs pour le provisionnement des adresses e-mail. Un alias est créé pour chaque valeur. Les alias existants dans Omni365 et qui ne sont pas dans le dossier LDAP sont supprimés.",
